				...
				_cc(h, [
					...
					},
					{
						...
						value: function () {
							...
							this.c.setAttribute(
								"style",
								"position:absolute;z-index:-1;top:0;left:0;right:0;bottom:0;box-shadow:0px 4px black;-webkit-transform:" +
									e +
									";transform:" +
									e +
									";outline: 1px solid black;background-color:rgba(" +
									this.bc.r +
									"," +
									this.bc.g +
									"," +
...
new FinisherHeader({
	...
	colors: {
		background: "#219ebc",
		particles: ["#6be2ff", "#176e83", "#29805f", "#54cb9e", "#10563b"],
	},
	blending: "lighten",
	opacity: {
		center: 0.6,
